...
export class ExamplesComponent implements OnInit, OnDestroy {
  ...
  examples = [
    { link: 'todos', label: 'orbi.examples.menu.todos' },
    { link: 'stock-market', label: 'orbi.examples.menu.stocks' },
    { link: 'theming', label: 'orbi.examples.menu.theming' },
    { link: 'authenticated', label: 'orbi.examples.menu.auth', auth: true }
  ];
